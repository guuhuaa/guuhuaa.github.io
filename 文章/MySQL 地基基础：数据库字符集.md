...
<h4>数据库级设置字符集</h4>
<ul>
<li>创建数据库时指定字符集（create database ... ）</li>
<li>修改数据库时修改字符集（alter database ...）</li>
</ul>
<p>注：对于已经存在的数据修改字符集无效。</p>
<h4>表级设置字符集</h4>
<ul>
<li>创建表时指定字符集（create table ...）</li>
<li>修改表时修改字符集（alter table ...）</li>
</ul>
<p>注：对于已经存在的数据修改字符集无效。</p>
<h4>列级设置字符集</h4>
<ul>
<li>创建表时指定列字符集（create table ...）</li>
<li>修改表时修改列字符集（alter table ...）</li>
</ul>
<p>注：对于已经存在的数据修改字符集无效。</p>
