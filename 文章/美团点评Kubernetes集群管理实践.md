...
<p>我们把该项优化贡献给了 Kubernetes社区(详见<a href="https://github.com/kubernetes/kubernetes/pull/56926">PR</a>)，增加了 alwaysCheckAllPredicates 策略选项，并在 Kubernetes1.10版本发布并开始作为默认的调度策略，当然你也可以通过设置alwaysCheckAllPredicates=true使用原先的调度策略。</p>
