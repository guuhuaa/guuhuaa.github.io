...
<head>
    <head>
        ...
        <title>认识 MySQL 和 Redis 的数据一致性问题.md</title>
...
<div class="book-container">
        ...
        <div class="book-menu uncollapsible">
            ...
            <ul class="uncollapsible">
                ...
                <li>
                    ...
                    <a class="current-tab" href="认识&#32;MySQL&#32;和&#32;Redis&#32;的数据一致性问题.md">认识 MySQL 和 Redis 的数据一致性问题.md</a>
    ...
    overflow-y: hidden;">
                    <div class="book-post">
                        ...
                        <div><h1>认识 MySQL 和 Redis 的数据一致性问题</h1>
<h3><strong>1. 什么是数据的一致性</strong></h3>
...
<p><img src="https://pic2.zhimg.com/v2-743a97e88d1d0bf906b7e1e3bec7a99d_b.jpg" alt="img" /></p>
<ul>
...
<h3><strong>2.2 针对读写缓存（更新数据库+更新缓存）</strong></h3>
...
<p><img src="https://pic3.zhimg.com/v2-b41f38d2c55bbfba734d3463c2d6ce46_b.jpg" alt="img" /></p>
<p>其中，分布式锁的实现可以使用以下策略：</p>
<p><img src="assets/v2-ea428da2331b4f04f65fb720ac80a829_b.jpg" alt="img" /></p>
<h3><strong>2.3 强一致性策略</strong></h3>
...
<h3><strong>3. 数据一致性中需要注意的其他问题有哪些？</strong></h3>
...
<li>补充细节</li>
                    ...
                    <div>
                        <div style="float: left">
                            <a href="解读《阿里巴巴&#32;Java&#32;开发手册》背后的思考.md">上一页</a>
                        </div>
                        <div style="float: right">
                            <a href="进阶：Dockerfile&#32;高阶使用指南及镜像优化.md">下一页</a>
                        </div>
                    </div>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v64f9daad31f64f81be21cbef6184a5e31634941392597" integrity="sha512-gV/bogrUTVP2N3IzTDKzgP0Js1gg4fbwtYB6ftgLbKQu/V8yH2+lrKCfKHelh4SO3DPzKj4/glTO+tNJGDnb0A==" data-cf-beacon='{"rayId":"6b4364708e2d645f","version":"2021.11.0","r":1,"token":"1f5d475227ce4f0089a7cff1ab17c0f5","si":100}' crossorigin="anonymous"></script>
</body>
